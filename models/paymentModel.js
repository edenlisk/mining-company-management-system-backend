...
//         const lot = await LotModel.findById(this.lotId);
...
//                         {
//                             date: (new Date()).toDateString(),
//                             comment: `Deducted ${lot.netPrice} for paying mineral price of ${lot.lotNumber} of minerals supplied on ${entry.supplyDate}.`
//                         }
//                     )
